...
const stats = [
  { icon: Users, label: "Clientes Ativos", value: "324", color: "blue" },
  { icon: Gift, label: "Recompensas Utilizadas", value: "87", color: "purple" },
  { icon: TrendingUp, label: "Taxa de Retenção", value: "94%", color: "green" },
  { icon: DollarSign, label: "Receita Mês", value: "R$ 12.450", color: "amber" },
];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {stats.map((stat, i) => (
          <div key={i} className="bg-white rounded-lg p-6 border border-slate-200 hover:shadow-lg transition">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 border border-slate-200">
          <h3 className="text-lg font-semibold text-slate-900 mb-4">Visitas por Mês</h3>
      ...
      {/* Recent Clients */}
      <div className="bg-white rounded-lg p-6 border border-slate-200">
        <h3 className="text-lg font-semibold text-slate-900 mb-4">Clientes Recentes</h3>
        <table className="w-full">
          <thead className="border-b border-slate-200">
            <tr>
              <th className="text-left py-3 px-4 text-sm font-semibold text-slate-600">Nome</th>
              <th className="text-left py-3 px-4 text-sm font-semibold text-slate-600">Telefone</th>
          ...
          <tbody>
            {[
              ...
              <tr key={i} className="border-b border-slate-100 hover:bg-slate-50">
                <td className="py-3 px-4 text-sm text-slate-900">{client.name}</td>
                <td className="py-3 px-4 text-sm text-slate-600">{client.phone}</td>
                <td className="py-3 px-4 text-sm text-slate-600">{client.visits}</td>
